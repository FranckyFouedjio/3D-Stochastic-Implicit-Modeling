...
T1=Sys.time()
Res=R_multiple_run_global_PPO(full_grid_points,grid_points,cell_size_x,cell_size_y,cell_size_z,phi_g_fields_list,psd_data,min_sill,max_sill,min_range,max_range,vol_min,vol_max,niter,path,nrun)
T2=Sys.time()
difftime(T2,T1)
closeAllConnections()

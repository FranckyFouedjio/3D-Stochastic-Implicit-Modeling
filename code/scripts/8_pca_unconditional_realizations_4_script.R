...
#############################################################################################################
#                                                                                                           #
#                   SYNTHETIC CASE STUDY: PCA OF UNCONDITIONAL REALIZATIONS (FORMATION 4)                   #
#                                                                                                           #
#############################################################################################################
...
if(!file.exists("./outputs/figures/8_pca_unconditional_realizations/4")){dir.create("./outputs/figures/8_pca_unconditional_realizations/4")}
...
## PCA
pca_unconditional_sdf=full_evd_fast(paste("./outputs/data/unconditional_realizations/unconditional_sdf_model_",4,".feather",sep=""))
...
saveRDS(pca_unconditional_sdf, file= paste("./outputs/data/pca_unconditional_realizations/pca_unconditional_sdf_",4,".rds",sep=""))
...
l=1
png(paste("./outputs/figures/8_pca_unconditional_realizations/4/Uncon_PC_Scores_",l,"_",l+1,".png",sep=""),width=5,height=5,units="in",res=300)
...
png("./outputs/figures/8_pca_unconditional_realizations/4/Model_Explained_Variance_PCA.png",width=5,height=5,units="in",res=300)
